        ...
        <div className="px-6 py-4 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    disabled={!hasPrevPage}
                    className="p-2 rounded-lg border border-divider hover:bg-background-secondary disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    title="Previous Page"
                >
                        ...
                        page === "..." ? (
                            ...
                            <button
                                ...
                                className={`px-3 py-1 rounded-lg transition-colors ${
                                    page === currentPage
                                        ? "bg-accent-1 text-white font-medium"
                                        : "border border-divider hover:bg-background-secondary text-text-primary"
                                }`}
                            >
                                {page}
                            </button>
