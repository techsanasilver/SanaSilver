...
class ErrorBoundary extends Component {
    ...
    render() {
        if (this.state.hasError) {
            ...
            // Default fallback UI
            return (
                <div className="min-h-screen flex items-center justify-center bg-background-primary p-4 min-w-screen">
                    <div className="max-w-md w-full bg-background-secondary rounded-lg shadow-lg p-8 text-center">
                        ...
                        <div className="flex gap-3 justify-center">
                            ...
                            <button
                                ...
                                className="px-6 py-2 bg-background-primary text-text-primary border border-divider rounded-md hover:bg-background-secondary transition-colors"
                            >
                                Reload Page
                            </button>
                        </div>
