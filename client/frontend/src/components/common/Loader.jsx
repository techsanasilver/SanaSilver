...
const Loader = ({
    ...
    const variantClasses = {
        primary: "border-accent-1 border-t-transparent",
        secondary: "border-accent-2 border-t-transparent",
        ...
        return (
            <div className="fixed inset-0 bg-background-primary/80 backdrop-blur-sm flex items-center justify-center z-50">
                <div className="flex flex-col items-center gap-4">
                    ...
                    {text && (
                        <p
                            className={`${textSizeClasses[size]} text-text-primary font-medium`}
                        >
                            {text}
                        </p>
                    )}
    ...
    return (
        <div className=" w-full h-full flex items-center justify-center gap-3">
            <div className={spinnerClasses} />
            {text && (
                <span className={`${textSizeClasses[size]} text-text-primary`}>
                    {text}
                </span>
            )}
        </div>
